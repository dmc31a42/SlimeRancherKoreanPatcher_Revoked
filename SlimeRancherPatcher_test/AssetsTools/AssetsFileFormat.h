...
struct TypeTree
{
	...
	ASSETSTOOLS_API QWORD Read(QWORD absFilePos, AssetsFileReader reader, LPARAM readerPar, DWORD version, bool bigEndian); //Minimum AssetsFile format : 7
